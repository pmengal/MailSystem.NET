    ...
    public class SmtpClient : System.Net.Sockets.TcpClient
	{
		...
		public event ActiveUp.Net.Mail.MessageSentEventHandler MessageSent;
		    ...
		    internal void OnMessageSending(ActiveUp.Net.Mail.MessageSendingEventArgs e)
		    {
			    ...
			    ActiveUp.Net.Mail.Logger.AddEntry(GetType(), "Sending message with subject : " + e.Message.Subject+"...",2);
		    }
		    internal void OnMessageSent(ActiveUp.Net.Mail.MessageSentEventArgs e)
		    {
			    if(MessageSent!=null) MessageSent(this,e);
			    ActiveUp.Net.Mail.Logger.AddEntry(GetType(), "Sent message with subject : " + e.Message.Subject+"...",2);
            }
        ...
        #region Delegates and associated private fields
            ...
            private string _CramMd5(string username, string password)
            {
                ...
                byte[] data = System.Convert.FromBase64String(this.Command("auth cram-md5", 334).Split(' ')[1].Trim(new char[] { '\r', '\n' }));
                string digest = System.Text.Encoding.ASCII.GetString(data,0,data.Length);
                string response = this.Command(System.Convert.ToBase64String(System.Text.Encoding.ASCII.GetBytes(username + " " + ActiveUp.Net.Mail.Crypto.HMACMD5Digest(password, digest))), 235);
            ...
            #region Public methods
                ...
                #region Connecting, authenticating and disconnecting
	                ...
	                public new string Connect(string host, int port)
	                {
		                ...
		                //System.IO.StreamReader sr = new System.IO.StreamReader(this.GetStream(),System.Text.Encoding.ASCII);
                        string response = this.ReadLine();// sr.ReadLine();
...
#if !PocketPC
                        return this._delegateConnectIPAddresses.BeginInvoke(addresses, port, callback, this._delegateConnectSslIPAddresses);
#else
		        ...
		        {
			        if(command.Length<200) this.OnTcpWriting(new ActiveUp.Net.Mail.TcpWritingEventArgs(command));
			        else this.OnTcpWriting(new ActiveUp.Net.Mail.TcpWritingEventArgs("Message Data"));
			        this.GetStream().Write(System.Text.Encoding.ASCII.GetBytes(command+"\r\n"),0,command.Length+2);
			        if(command.Length<200) this.OnTcpWritten(new ActiveUp.Net.Mail.TcpWrittenEventArgs(command));
			        else this.OnTcpWritten(new ActiveUp.Net.Mail.TcpWrittenEventArgs("Message Data"));
			        System.IO.StreamReader sr = new System.IO.StreamReader(this.GetStream(),System.Text.Encoding.ASCII);
			        ...
			        while(true)
			        {
				        ...
				        if(line!=null)
				        {
					        ...
					        else throw new ActiveUp.Net.Mail.SmtpException("Command \""+command+"\" failed : "+line);
				        }
                        else throw new ActiveUp.Net.Mail.SmtpException("Could not read response from the server. The connection has been closed by the remote server.");
			        }
                ...
                {
                    return this.BeginData(new System.IO.StreamReader(dataFilePath, System.Text.Encoding.ASCII).ReadToEnd(), callback);
                }
                ...
                #region Sending methods
                    ...
                    public static IAsyncResult BeginDirectSend(Message message, AsyncCallback callback)
                    {
                        ...
                        return SmtpClient._delegateDirectSendMessage.BeginInvoke(message, callback, SmtpClient._delegateDirectSendMessage);
                    }
                    ...
                    public static IAsyncResult BeginDirectSend(Message message, string dnsHost, int dnsPort, AsyncCallback callback)
                    {
                        ...
                        return SmtpClient._delegateDirectSendMessageStringInt.BeginInvoke(message, dnsHost, dnsPort, callback, SmtpClient._delegateDirectSendMessageStringInt);
                    }
                    ...
                    public static IAsyncResult BeginDirectSend(Message message, string dnsHost, AsyncCallback callback)
                    {
                        ...
                        return SmtpClient._delegateDirectSendMessageString.BeginInvoke(message, dnsHost, callback, SmtpClient._delegateDirectSendMessageString);
                    }
                    ...
                    public static IAsyncResult BeginDirectSend(Message message, ServerCollection dnsServers, AsyncCallback callback)
                    {
                        ...
                        return SmtpClient._delegateDirectSendMessageServerCollection.BeginInvoke(message, dnsServers, callback, SmtpClient._delegateDirectSendMessageServerCollection);
                    }
                    ...
                    public static IAsyncResult BeginDirectSendCollection(MessageCollection messages, AsyncCallback callback)
                    {
                        ...
                        return SmtpClient._delegateDirectSendMessageCollection.BeginInvoke(messages, callback, SmtpClient._delegateDirectSendMessageCollection);
                    }
                    ...
                    public static IAsyncResult BeginDirectSendCollection(MessageCollection messages, string dnsHost, int dnsPort, AsyncCallback callback)
                    {
                        ...
                        return SmtpClient._delegateDirectSendMessageCollectionStringInt.BeginInvoke(messages, dnsHost, dnsPort, callback, SmtpClient._delegateDirectSendMessageCollectionStringInt);
                    }
                    ...
                    public static IAsyncResult BeginDirectSendCollection(MessageCollection messages, ref SmtpExceptionCollection errors, AsyncCallback callback)
                    {
                        ...
                        return SmtpClient._delegateDirectSendMessageCollectionSmtpExceptionCollection.BeginInvoke(messages, ref errors, callback, SmtpClient._delegateDirectSendMessageCollectionSmtpExceptionCollection);
                    }
		            ...
		            public static void SendQueued(ActiveUp.Net.Mail.Message message, string spoolDirectory, ActiveUp.Net.Mail.QueuingService queuingService)
		            {
			            ...
			            ActiveUp.Net.Mail.Logger.AddEntry(typeof(SmtpClient), "UID Created for filename: '" + UID + "'", 0);
                    ...
                    public static IAsyncResult BeginSendQueued(Message message, string spoolDirectory, QueuingService queuingService, AsyncCallback callback)
                    {
                        ...
                        return SmtpClient._delegateSendQueuedMessage.BeginInvoke(message, spoolDirectory, queuingService, callback, SmtpClient._delegateSendQueuedMessage);
                    }
		            ...
		            /// <param name="spoolDirectory">The full path to the full directory.</param>
		            /// <param name="queuingService">The queuing service to use.</param>
		            public static void SendQueued(ActiveUp.Net.Mail.MessageCollection messages, string spoolDirectory, ActiveUp.Net.Mail.QueuingService queuingService)
		            {
			            foreach(ActiveUp.Net.Mail.Message message in messages)
			            {
                    ...
                    public static IAsyncResult BeginSend(Message message, ServerCollection servers, AsyncCallback callback)
                    {
                        ...
                        return SmtpClient._delegateSendMessageServerCollection.BeginInvoke(message, servers, callback, SmtpClient._delegateSendMessageServerCollection);
                    }
                    ...
                    public static IAsyncResult BeginSend(Message message, string server, AsyncCallback callback)
                    {
                        ...
                        return SmtpClient._delegateSendMessageString.BeginInvoke(message, server, callback, SmtpClient._delegateSendMessageString);
                    }
                    ...
                    {
                        SmtpClient._delegateSendMessageStringInt = SmtpClient.Send;
                        return SmtpClient._delegateSendMessageStringInt.BeginInvoke(message, host, port, callback, SmtpClient._delegateSendMessageStringInt);
                    }
                    ...
                    public static IAsyncResult BeginSend(Message message, string host, string username, string password, SaslMechanism mechanism, AsyncCallback callback)
                    {
                        ...
                        return SmtpClient._delegateSendMessageStringStringStringSaslMechanism.BeginInvoke(message, host, username, password, mechanism, callback, SmtpClient._delegateSendMessageStringStringStringSaslMechanism);
                    }
                    ...
                    public static IAsyncResult BeginSendCollection(MessageCollection messages, string host, AsyncCallback callback)
                    {
                        ...
                        return SmtpClient._delegateSendMessageCollectionString.BeginInvoke(messages, host, callback, SmtpClient._delegateSendMessageCollectionString);
                    }
                    ...
                    public static IAsyncResult BeginSendCollection(MessageCollection messages, string host, ref SmtpExceptionCollection errors, AsyncCallback callback)
                    {
                        ...
                        return SmtpClient._delegateSendMessageCollectionStringSmtpExceptionCollection.BeginInvoke(messages, host, ref errors, callback, SmtpClient._delegateSendMessageCollectionStringSmtpExceptionCollection);
                    }
                    ...
                    public static IAsyncResult BeginSendCollection(MessageCollection messages, ServerCollection servers, AsyncCallback callback)
                    {
                        ...
                        return SmtpClient._delegateSendMessageCollectionServerCollection.BeginInvoke(messages, servers, callback, SmtpClient._delegateSendMessageCollectionServerCollection);
                    }
                    ...
                    {
                        SmtpClient._delegateSendMessageCollectionStringStringStringSaslMechanismSmtpExceptionCollection = SmtpClient.SendCollection;
                        return SmtpClient._delegateSendMessageCollectionStringStringStringSaslMechanismSmtpExceptionCollection.BeginInvoke(messages, host, username, password, mechanism, ref errors, callback, SmtpClient._delegateSendMessageCollectionStringStringStringSaslMechanismSmtpExceptionCollection);
                    }
                    ...
                    public static IAsyncResult BeginSendCollection(MessageCollection messages, string host, int port, string username, string password, SaslMechanism mechanism, AsyncCallback callback)
                    {
                        ...
                        return SmtpClient._delegateSendMessageCollectionStringIntStringStringSaslMechanism.BeginInvoke(messages, host, port, username, password, mechanism, callback, SmtpClient._delegateSendMessageCollectionStringIntStringStringSaslMechanism);
                    }
		            ...
		            {
                        ActiveUp.Net.Mail.SmtpClient.QuickSend(from, to, subject, textBody, BodyFormat.Text, string.Empty, string.Empty);
                    ...
                    {
                        SmtpClient._delegateQuickDirectSend = SmtpClient.QuickDirectSend;
                        return SmtpClient._delegateQuickDirectSend.BeginInvoke(from, to, subject, textBody, callback, SmtpClient._delegateQuickDirectSend);
                    }
		            ...
		            {
                        ActiveUp.Net.Mail.SmtpClient.QuickSend(from, to, subject, textBody, BodyFormat.Text, attachmentPath, string.Empty);
			            /*ActiveUp.Net.Mail.Message message = new ActiveUp.Net.Mail.Message();
			            //message.From.Add(new ActiveUp.Net.Mail.Address(from));
			            message.From = new ActiveUp.Net.Mail.Address(from);
			            message.To.Add(to);
                    ...
                    public static IAsyncResult BeginQuickDirectSend(string from, string to, string subject, string textBody, string attachmentPath, AsyncCallback callback)
                    {
                        ...
                        return SmtpClient._delegateQuickDirectSendAttach.BeginInvoke(from, to, subject, textBody, BodyFormat.Text, attachmentPath, callback, SmtpClient._delegateQuickDirectSendAttach);
                    }
		            ...
		            {
                        ActiveUp.Net.Mail.SmtpClient.QuickSend(from, to, subject, textBody, BodyFormat.Text, string.Empty, smtpServer);
			            /*ActiveUp.Net.Mail.Message message = new ActiveUp.Net.Mail.Message();
			            message.From = new ActiveUp.Net.Mail.Address(from);
			            message.To.Add(to);
			            message.Subject = subject;
                    ...
                    {
                        SmtpClient._delegateQuickSend = SmtpClient.QuickSend;
                        return SmtpClient._delegateQuickSend.BeginInvoke(from, to, subject, textBody, smtpServer, callback, SmtpClient._delegateQuickSend);
                    }
		            ...
		            {
                        ActiveUp.Net.Mail.SmtpClient.QuickSend(from, to, subject, textBody, BodyFormat.Text, attachmentPath, smtpServer);
			            /*ActiveUp.Net.Mail.Message message = new ActiveUp.Net.Mail.Message();
			            message.From = new ActiveUp.Net.Mail.Address(from);
			            message.To.Add(to);
			            message.Subject = subject;
                    ...
                    {
                        SmtpClient._delegateQuickSendAttach = SmtpClient.QuickSend;
                        return SmtpClient._delegateQuickSendAttach.BeginInvoke(from, to, subject, textBody, BodyFormat.Text, attachmentPath, smtpServer, callback, SmtpClient._delegateQuickSendAttach);
                    }
