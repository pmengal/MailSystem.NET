...
namespace ActiveUp.Net.Groupware.vCard
{
	...
	public class TelephoneNumberCollection : System.Collections.CollectionBase
	{
		...
		public ActiveUp.Net.Groupware.vCard.TelephoneNumber this[int index]
		{
			get
			{
				return (ActiveUp.Net.Groupware.vCard.TelephoneNumber)this.List[index];
			}
		}
		/// <summary>
		...
		public ActiveUp.Net.Groupware.vCard.TelephoneNumber GetPrefered()
		{
			foreach(ActiveUp.Net.Groupware.vCard.TelephoneNumber number in this)	if(number.IsPrefered) return number;
			return null;
		}
	}
}
