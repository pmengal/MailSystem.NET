...
{
	/// <summary>
	/// Summary description for ActiveMailExpired.
	/// </summary>
	public class PageActiveMailNotFound : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.CheckBox _cbDisplayAgain;
		...
		private void InitializeComponent()
		{
			...
			this._cbDisplayAgain = new System.Windows.Forms.CheckBox();
			...
			// _cbDisplayAgain
			// 
			this._cbDisplayAgain.BackColor = System.Drawing.Color.Transparent;
			this._cbDisplayAgain.Location = new System.Drawing.Point(184, 104);
			this._cbDisplayAgain.Name = "_cbDisplayAgain";
			this._cbDisplayAgain.Size = new System.Drawing.Size(216, 16);
			this._cbDisplayAgain.TabIndex = 3;
			this._cbDisplayAgain.Text = "Don\'t display this error message again";
			// 
			// pictureBox1
			// 
			...
			this.Closing += new System.ComponentModel.CancelEventHandler(this.PageActiveMailExpired_Closing);
		...
		private void SetRegistryValues()
		{
			...
			RegistryKey key = Registry.LocalMachine.CreateSubKey(keyString); 
			if (_cbDisplayAgain.Checked == false)
				key.SetValue("ActiveMailNotFound",true);
			else
				key.SetValue("ActiveMailNotFound",false);
			key.Close();
		}

		private void PageActiveMailExpired_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			SetRegistryValues();
		}
