...
namespace ActiveUp.Net.WhoIs
{
    ...
    public class ServerCollection : CollectionBase
    {
        ...
        {
            return List.Add(new Server(host,port));
        }
        ...
        {
            return List.Add(new Server(host,domain));
        }
        ...
        {
            return List.Add(new Server(host,port,domain));
        }
        ...
        {
            return List.Add(new Server(host,port,domain,noMatch));
        }
