...
namespace ActiveUp.Net.Tests
{
    ...
    public class CommonTests
    {
        ...
        public void ParseMultipleMessageTraceMessageDate()
        {
            ...
            Message message = Parser.ParseMessageFromFile(_baseDir + "\\resource\\testmail.eml");
...
".Replace("\r\n", "");
            #endregion
            Message message = Parser.ParseMessageFromFile(_baseDir + "\\resource\\testmail-quoted-printable.eml");
