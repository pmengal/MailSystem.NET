...
namespace ActiveUp.Net.Mail.PDI.vCard
{
	...
	public class vCard
	{
		...
		private ActiveUp.Net.Mail.PDI.vCard.AddressCollection _addresses = new ActiveUp.Net.Mail.PDI.vCard.AddressCollection();
		private ActiveUp.Net.Mail.PDI.vCard.EmailAddressCollection _emails = new ActiveUp.Net.Mail.PDI.vCard.EmailAddressCollection();
		//private ActiveUp.Net.Mail.PDI.vCard.vCard _agent = new ActiveUp.Net.Mail.PDI.vCard.vCard();
		private ActiveUp.Net.Mail.PDI.vCard.LabelCollection _labels = new ActiveUp.Net.Mail.PDI.vCard.LabelCollection();
		private ActiveUp.Net.Mail.PDI.vCard.TelephoneNumberCollection _telnums = new ActiveUp.Net.Mail.PDI.vCard.TelephoneNumberCollection();
        private ActiveUp.Net.Mail.PDI.vCard.GeographicalPosition _geo = new ActiveUp.Net.Mail.PDI.vCard.GeographicalPosition();
		private ActiveUp.Net.Mail.PDI.vCard.Name _n = new ActiveUp.Net.Mail.PDI.vCard.Name();
		...
		/// </summary>
		public ActiveUp.Net.Mail.PDI.vCard.Name Name
		{
			get
			{
				return this._n;
		...
		/// </summary>
		public ActiveUp.Net.Mail.PDI.vCard.AddressCollection Addresses
		{
			get
			{
		...
		/// </summary>
		public ActiveUp.Net.Mail.PDI.vCard.TelephoneNumberCollection TelephoneNumbers
		{
			get
			{
		...
		/// </summary>
		public ActiveUp.Net.Mail.PDI.vCard.vCard Agent
		{
			get
			{
				return this._agent;
		...
		/// </summary>
		public ActiveUp.Net.Mail.PDI.vCard.LabelCollection Labels
		{
			get
			{
				return this._labels;
		...
		/// </summary>
		public ActiveUp.Net.Mail.PDI.vCard.EmailAddressCollection EmailAddresses
		{
			get
			{
				return this._emails;
		...
		public string GetData()
		{
			...
			if(this.FullName!=null) sw.WriteLine("FN:"+ActiveUp.Net.Mail.PDI.vCard.Parser.Escape(this.FullName));
			if(this.DisplayName!=null) sw.WriteLine("NAME:"+ActiveUp.Net.Mail.PDI.vCard.Parser.Escape(this.DisplayName));
			if(this.GeneratorId!=null) sw.WriteLine("PRODID:"+ActiveUp.Net.Mail.PDI.vCard.Parser.Escape(this.GeneratorId));
			if(this.Mailer!=null) sw.WriteLine("MAILER:"+ActiveUp.Net.Mail.PDI.vCard.Parser.Escape(this.Mailer));
			if(this.Nickname!=null) sw.WriteLine("NICKNAME:"+ActiveUp.Net.Mail.PDI.vCard.Parser.Escape(this.Nickname));
			if(this.Note!=null) sw.WriteLine("NOTE:"+ActiveUp.Net.Mail.PDI.vCard.Parser.Escape(this.Note));
			if(this.Role!=null) sw.WriteLine("ROLE:"+ActiveUp.Net.Mail.PDI.vCard.Parser.Escape(this.Role));
			if(this.SortText!=null) sw.WriteLine("SORT-STRING:"+ActiveUp.Net.Mail.PDI.vCard.Parser.Escape(this.SortText));
			if(this.Source!=null) sw.WriteLine("SOURCE:"+ActiveUp.Net.Mail.PDI.vCard.Parser.Escape(this.Source));
			if(this.TimeZone!=null) sw.WriteLine("TZ:"+ActiveUp.Net.Mail.PDI.vCard.Parser.Escape(this.TimeZone));
			if(this.Title!=null) sw.WriteLine("TITLE:"+ActiveUp.Net.Mail.PDI.vCard.Parser.Escape(this.Title));
			if(this.AccessClass!=null) sw.WriteLine("CLASS:"+ActiveUp.Net.Mail.PDI.vCard.Parser.Escape(this.AccessClass));
			if(this.Addresses.Count>0) foreach(ActiveUp.Net.Mail.PDI.vCard.Address address in this.Addresses) sw.WriteLine(address.GetFormattedLine());
			if(this.EmailAddresses.Count>0) foreach(ActiveUp.Net.Mail.PDI.vCard.EmailAddress email in this.EmailAddresses) sw.WriteLine(email.GetFormattedLine());
			if(this.Labels.Count>0) foreach(ActiveUp.Net.Mail.PDI.vCard.Label label in this.Labels) sw.WriteLine(label.GetFormattedLine());
			if(this.TelephoneNumbers.Count>0) foreach(ActiveUp.Net.Mail.PDI.vCard.TelephoneNumber number in this.TelephoneNumbers) sw.WriteLine(number.GetFormattedLine());
            ...
            if(this.Organization!=null && this.Organization.Count>0)
            {
				...
				foreach(string str in this.Organization) organization += ActiveUp.Net.Mail.PDI.vCard.Parser.Escape(str)+",";
            ...
            if (this.Categories != null && this.Categories.Count > 0)
			{
				...
				foreach(string str in this.Categories) categories += ActiveUp.Net.Mail.PDI.vCard.Parser.Escape(str)+",";
			...
			return ActiveUp.Net.Mail.PDI.vCard.Parser.Fold(sw.ToString());
		}
	}
}
