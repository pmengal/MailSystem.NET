namespace ActiveUp.Net.Mail.PDI.vCard
{
	...
	public class Address
	{
		...
		public string GetFormattedLine()
		{
			...
			if(this.ExtendedAddress!=null) sb.Append(ActiveUp.Net.Mail.PDI.vCard.Parser.Escape(this.ExtendedAddress)+";");
			else sb.Append(";");
			if(this.StreetAddress!=null) sb.Append(ActiveUp.Net.Mail.PDI.vCard.Parser.Escape(this.StreetAddress)+";");
			else sb.Append(";");
			if(this.Locality!=null) sb.Append(ActiveUp.Net.Mail.PDI.vCard.Parser.Escape(this.Locality)+";");
			else sb.Append(";");
			if(this.Region!=null) sb.Append(ActiveUp.Net.Mail.PDI.vCard.Parser.Escape(this.Region)+";");
			else sb.Append(";");
			if(this.PostalCode!=null) sb.Append(ActiveUp.Net.Mail.PDI.vCard.Parser.Escape(this.PostalCode)+";");
			else sb.Append(";");
			if(this.Country!=null) sb.Append(ActiveUp.Net.Mail.PDI.vCard.Parser.Escape(this.Country)+";");
			else sb.Append(";");
			sb.Remove(sb.Length-1,1);
			return sb.ToString();
		}
