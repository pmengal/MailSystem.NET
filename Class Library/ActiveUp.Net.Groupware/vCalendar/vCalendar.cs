...
namespace ActiveUp.Net.Groupware.vCalendar
{
    ...
    public class vCalendar
    {
        ...
        public GeographicalPosition GeographicalPosition { get; set; } = new GeographicalPosition();
        public DayLightSavings DayLightSavings { get; set; } = new DayLightSavings();
        public string GeneratorId { get; set; }
        public string TimeZone { get; set; }
        public vEventCollection Events { get; set; } = new vEventCollection();
        public vTodoCollection Todos { get; set; } = new vTodoCollection();
