...
namespace ActiveUp.Net.Security.OpenPGP
{
    public class Constants : NameValueCollection
    {
        ...
        {
            if (skAlgorithm.Equals(SymmetricKeyAlgorithm.IDEA))
                return IDEA_CIPHER_BLOCK_SIZE;
